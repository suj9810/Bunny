...
public enum UserErrorCode implements ResponseCode {
	...
	USER_NOT_SOFT_DELETED(HttpStatus.BAD_REQUEST, "소프트 삭제된 사용자만 하드 삭제할 수 있습니다.", "USER_NOT_SOFT_DELETED"),
	...
	LOGOUT_FAILED(HttpStatus.UNAUTHORIZED, "로그인이 필요합니다.", "LOGOUT_FAILED"),
